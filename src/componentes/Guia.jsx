...
export default function () {
  return (
    ...
    <div className='p-12'>
        ...
        <p className='font-lilita flex justify-center  text-xl text-left mt-8 text-stone-300'> Criação de Conta: Crie uma conta no aplicativo para ter acesso a todos os recursos e  funcionalidades da plataforma Cultucana</p>
    </div>
    <div>
    ...
    <div>
        <p className='font-lilita flex justify-center  text-xl text-center mt-8 text-stone-300'>Verificação Regular: Inspecione periodicamente o dispositivo para garantir <br /> que ele  esteja firmemente instalado no solo e que nenhum sensor tenha sido danificado ou  removido.</p>
        <p className='font-lilita flex justify-center  text-xl text-center mt-8 text-stone-300' > Atualizações do Aplicativo: Mantenha o aplicativo Cultucana atualizado com a última  versão para garantir o acesso às funcionalidades mais recentes e correções de bugs</p>
    </div>
